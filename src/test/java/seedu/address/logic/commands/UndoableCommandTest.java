...
public class UndoableCommandTest {
    private final Model model = new ModelManager(getTypicalAddressBookPersons(), new UserPrefs());
    ...
    public void executeUndo() throws Exception {
        ...
        dummyCommand.undo();
        expectedModel = new ModelManager(getTypicalAddressBookPersons(), new UserPrefs());
        assertEquals(expectedModel, model);
    }
