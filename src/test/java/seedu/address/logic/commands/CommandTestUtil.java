...
public class CommandTestUtil {
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhones(VALID_PHONE_AMY).withBirthday(VALID_BIRTHDAY_AMY).withEmail(VALID_EMAIL_AMY)
                .withAddress(VALID_ADDRESS_AMY).withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhones(VALID_PHONE_BOB).withBirthday(VALID_BIRTHDAY_BOB).withEmail(VALID_EMAIL_BOB)
        ...
        DESC_CARRIE = new EditPersonDescriptorBuilder().withName(VALID_NAME_CARRIE)
                .withPhones(VALID_PHONE_CARRIE).withBirthday(VALID_BIRTHDAY_CARRIE).withEmail(VALID_EMAIL_CARRIE)
                .withAddress(VALID_ADDRESS_CARRIE).withTags(VALID_TAG_FRIEND).build();
    }
