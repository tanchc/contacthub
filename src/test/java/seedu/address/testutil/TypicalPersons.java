...
public class TypicalPersons {
    ...
    public static final ReadOnlyPerson BENSON = new PersonBuilder().withName("Benson Meier")
            ...
            .withEmail("johnd@example.com").withPhones("98765432").withBirthday("12/02/1985")
    ...
    public static final ReadOnlyPerson DANIEL = new PersonBuilder().withName("Daniel Meier")
            .withPhones("87652533").withBirthday("21/09/1988").withEmail("cornelia@example.com")
    ...
    public static final ReadOnlyPerson CARRIE = new PersonBuilder().withName(VALID_NAME_CARRIE)
            ...
            .withEmail(VALID_EMAIL_CARRIE).withAddress(VALID_ADDRESS_CARRIE).build();
