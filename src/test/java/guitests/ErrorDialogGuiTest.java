...
import static seedu.address.ui.UiManager.FILE_OPS_ERROR_DIALOG_SMODE_TITLE;
...
public class ErrorDialogGuiTest extends AddressBookGuiTest {
    ...
    public void showErrorDialogs() {
        ...
        guiRobot.waitForEvent(() -> guiRobot.isWindowShown(FILE_OPS_ERROR_DIALOG_SMODE_TITLE));

        AlertDialogHandle alertDialog = new AlertDialogHandle(guiRobot.getStage(FILE_OPS_ERROR_DIALOG_SMODE_TITLE));
