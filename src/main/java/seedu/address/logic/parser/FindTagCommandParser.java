 ...
 */
public class FindTagCommandParser implements Parser<FindModCommand> {
    ...
    public FindModCommand parse(String args) throws ParseException {
        ...
        return new FindModCommand(new ModContainsKeywordPredicate(Arrays.asList(nameKeywords)));
    }
