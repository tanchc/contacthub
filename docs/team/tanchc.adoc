...
*Code contributed*: [https://github.com/CS2103AUG2017-T11-B2/main/blob/master/collated/main/tanchc.md[Functional code]] [https://github.com/CS2103AUG2017-T11-B2/main/blob/master/collated/test/tanchc.md[Test code]] {give links to collated code files}
...
making ContactHub very useful for them.
...
contacts can be added more efficiently into ContactHub, thereby saving both the user's time and effort.

=== Other contributions

* Helped to resolve the problem of both person and task at index being selected (Pull requests https://github.com[#128])
