...
* Items in square brackets are optional e.g `n/NAME [m/MODULE]` can be used as `n/John Doe m/CS2101` or as `n/John Doe`.
...
* Each command has a given abbreviation you can use in place of the command itself. e.g. `clear` and `c` are both acceptable.
====
...
* Only the modules are searched.
* Only full words will be matched e.g. `CS2103` will not match `CS2103T`
* Modules matching at least one keyword will be returned (i.e. `OR` search). e.g. `CS2101 CS2103` will return
...
=== Adding a photo to a Person: `addPhoto` or `ap`

Add a custom photo to the profile a Person in Contacthub. +
...
Sets the photo of the 1st person to that in the given URL.
* `addphoto 1` +
Resets the photo of the 1st person back to the default image.
...
* *Add* `add n/NAME p/PHONE_NUMBER... b/BIRTHDAY e/EMAIL... a/ADDRESS [m/MODULE]...` +
e.g. `add n/James Ho p/22224444 p/66669999 b/02/02/1992 e/jamesho@example.com e/jho@live.com a/123, Clementi Rd, 1234665 m/CS2101` +
* *Clear* : `clear`
* *Delete* : `delete INDEX` +
e.g. `delete 3`
* *Edit* : `edit INDEX [n/NAME] [p/PHONE_NUMBER]... [b/BIRTHDAY] [e/EMAIL]... [a/ADDRESS] [m/MODULE]...` +
e.g. `edit 2 n/James Lee e/jameslee@example.com`
* *Find* : `find KEYWORD [MORE_KEYWORDS]` +
e.g. `find James Jake`
* *Find Module* : `findmodule KEYWORD [MORE_KEYWORDS]` +
e.g. `findmodule CS2101 CS2103`
* *Help* : `help`
* *History* : `history`
* *List* : `list`
