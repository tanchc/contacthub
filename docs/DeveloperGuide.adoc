...
|`* * *` |careless user |edit the contact once added |change my errors
...
|`* *` |demanding user |have suggestions for persons |have ease of access base on the frequency of accessing the person

|`* *` |demanding user |have the list to be updated immediately when i type the letters one by one |
...
2.  AddressBook shows the UserGuide to the user.
+
Use case ends.
...
1.  User adds a person to AddressBook
2.  AddressBook adds the person to the list
3.  AddressBook displays a successful added message with the person's details
+
Use case ends.
...
** 1a2. User adds a person to the AddressBook.
+
...
2. AddressBook shows a list of persons sorted alphabetically.
+
Use case ends.
...
5. AddressBook stores the new details of the person
+
Use case ends.
...
2.  AddressBook displays a list of person(s) with the same name
+
Use case ends.
...
[none]
* 2a. AddressBook does not contain the person.
+
Use case ends.
...
4.  AddressBook opens a Google Search of that person
+
Use case ends.
...
2. AddressBook displays a list of command history
+
Use case ends.
...
[none]
* 2a. AddressBook does not have any command history.
+
Use case ends.
...
2. AddressBook undo the last undoable command
+
Use case ends.
...
[none]
* 2a. AddressBook has no more undoable command
+
Use case ends.
...
2. AddressBook redo the last undoable command
+
Use case ends.
...
2. AddressBook clears all the data
+
Use case ends.
