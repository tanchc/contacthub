...
[NOTE]
Upon exiting ContactHub, the contact list will not be sorted in the next launch.
...
2.  AddressBook displays a list of person(s) with the tag name keyed in
+
Use case ends.
...
[none]
* 2a. AddressBook does not contain anyone with the tag.
+
Use case ends.
