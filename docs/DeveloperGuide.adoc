...
Suppose the user has jus added a contact into ContactHub. The photo of this contact will be defaultPhoto.
...
**Cons:** If there is no local photo of the contact, the user must download from the web onto hes computer first then
use the local URL in the `AddPhotoCommand`.
// end::addphoto[]
